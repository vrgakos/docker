...
install_runc() {
	...
	git clone https://github.com/vrgakos/runc.git "$GOPATH/src/github.com/opencontainers/runc"
...
install_containerd() {
	...
	git clone https://github.com/vrgakos/containerd.git "$GOPATH/src/github.com/docker/containerd"
